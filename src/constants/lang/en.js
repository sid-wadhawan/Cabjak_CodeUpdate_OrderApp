export default {
  ...
  ENTE_REGISTERED_EMAIL:
    'Enter registered email or phone number to login your account',
  LOGIN_ACCOUNT: 'LOGIN',
...
Amount`,
  ...
  MY_RIDES: 'MY RIDES',
  ACCOUNT1: 'ACCOUNT',
  RIDEANYWHERE: 'Ride anywhere, anytime.',
  ...
  CONNECTIONBACK: 'You are back online',
  SHARE: 'Share',
  ...
  WATCH: 'Watch',
  TRIPS: 'Trips',
  WATCHADTEXT: 'points each per ad',
  TRIPSADTEXT: 'points each trip (unlimited)',
  SHAREADTEXT: 'points each per share',
  BOOKACAB: 'Book a Cab',
  ENTER_OTP_SENT2: 'Enter the OTP sent to your registered email',
  ACTION1: 'Action Required  ⚠️',
  ACTION2: 'Settle your pending payments to continue Book a ride.',
  ...
  SHARELINE1:
    'Download Cabjak and 🎁 start earning rewards! Use my referral code',
  SHARELINE2: 'when you sign up.',
  ...
  SILVER: 'Silver',
  BRONZE: 'Bronze',
  PROGRESSGOLD: 'Progress towards the gold status',
  PROGRESSSILVER: 'Progress towards the silver status',
  CONGRATS: 'Congrats!',
  OUTOF: 'Out of',
  GENDERCAPTAIN: 'Gender Captain',
  SELECTGENDERCAP: 'Select Captain',
  CAPTAINGENDER: 'Captain Gender',
  CAPTAIN: 'Captain',
  ...
  UPDATE_TEXT2:
    'New version is now available with exciting new features and improvements. Would you like to update now?',
  UPDATE_TEXT3:
    'The update has been downloaded. Please Restart the app to apply the update.',
  SECUREONLINE: 'Secure Online Payments',
  CHARGESAPPY: 'Charges may apply',
  EXTRAP: 'Extra',
  FEESAPPY: 'fee apply',
  INFO: 'Info',
  CIVILIDNUM: 'Civil ID Number',
  NATIONALITY: 'Nationality',
  USEWALLET: 'Use Wallet',
  CAPTAINNATIONALITY: 'Captain Nationality',
  SELECTCAPTAINTYPE: 'Select Captain Type',
  GCCCAPT: 'GCC',
  SAUDICAP: 'Saudi',
  OTHERS2: 'Others',
  ALL2: 'Male or Female',
  MOBILEIDAUTH: 'Mobile ID Authentication...',
  BID_PRICE: 'Bid Price',
  KUWAITSIGNUPFIRST: 'Choose how you’d like to sign up!',
  KUWAITSIGNUPSECOND: 'Continue with Kuwait Mobile ID',
  SIGNUPMANUALLY: 'Sign up manually',
  KUWAITAUTHENTFIRST: 'Cabjak is pending authentication acceptance',
  KUWAITAUTHENTSECOND: 'Accept authentication request in Kuwait Mobile ID',
  NOMOBILEIDAPP: 'Mobile ID app is not available on this device.',
  SAFETYTOOLS: 'Safety tools',
  EMERGENCYTEXT: 'Emergency contact and recording',
  YOURSAFETY: 'Your  safety is our priority',
  USETHISTOOL: 'Use this tools anytime you need help during a ride.',
  EMERGENCYCONTACT: 'Emergency Contact',
  RECORDAUDIO: 'Record Audio',
  RECORDING: 'Recording...',
  STAYSAFE: 'Stay Safe on Every Ride',
  QUICKLYACCESS: 'Quickly access to emergency contact instantly.',
  VEHICLE: 'Vehicle',
  PLNUMBER: 'PL Number',
  ...
  SUBMITAUDIO: 'Do you want to submit the audio recording?',
  TRIPFARE: 'Trip fare',
  WEHOPEYOU: 'We hope you enjoyed your ride.',
  TRIPRECEIPT:'TRIP RECEIPT',
  THANKYOU:'THANK YOU!',
  ORDERID:'Order ID',
    WANTTOPAYWALLET:'Do you want to pay from Wallet?'
