      ...
      <ScrollView
        ...
        {!!userData?.auth_token &&
          ...
          appData?.profile?.preferences?.subscription_mode == 1 && (
            <ListItemHorizontal
              ...
              iconLeft={imagePath.IcRewardNoAc}
        ...
        {/* {!!userData?.auth_token && (
          <ListItemHorizontal
            centerContainerStyle={{flexDirection: 'row'}}
            leftIconStyle={{flex: 0.1, alignItems: 'center'}}
            onPress={moveToNewScreen(navigationStrings.LEADER_BOARD, {
              isBack: true,
            })}
            iconLeft={imagePath.myOrder2}
            centerHeading={'Leader Board'}
            containerStyle={styles.containerStyle2}
            centerHeadingStyle={{
              fontSize: textScale(14),
              fontFamily: fontFamily.regular,
        ...
        {/* <ListItemHorizontal
          centerContainerStyle={{flexDirection: 'row'}}
          leftIconStyle={{flex: 0.1, alignItems: 'center'}}
          onPress={moveToNewScreen(navigationStrings.REWARD1)}
          iconLeft={imagePath.reward}
