...
export default function ProductDetail({route, navigation}) {
  ...
  console.log(yesterday, 'yesterdayyayay');
  ...
  const [appointmentSelectedDate, setAppointmentSelectedDate] = useState(
    new Date(),
  );
  const [appointmentSelectedDateCount, setAppointmentSelectedDateCount] =
    useState(false);
  ...
  console.log(currencies, 'rfgthjkl');
    ...
    return (
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          ...
          <Text style={{color: isDarkMode ? colors.white : colors.textGrey}}>
            {item?.user?.name}
          </Text>
        </View>
        <StarRating
  ...
  console.log(productDetailData?.is_slot_from_dispatch, 'isAppointmentPicker');
  ...
  const onDateSelected = async date => {
    ...
    console.log(
      date,
      'date1121212',
      moment(date).format('DD') >= moment(todayDate).format('DD'),
    );
    ...
    if (isAppointmentPicker) {
      if (productDetailData?.is_slot_from_dispatch) {
        ...
        if (moment(date).format('DD') >= moment(todayDate).format('DD')) {
          try {
            ...
            if (res) {
              ...
              setAppointmentSelectedDateCount(true)
              setLoadingGetSlots(false);
              setAppointmentPicker(false);
              setSelectedAppointmentIndx(null);
              setSelectedAppointmentSlot({});
  ...
  return (
    ...
    >
      ...
      <KeyboardAwareScrollView ref={myRef} showsVerticalScrollIndicator={false}>
        <View style={{marginHorizontal: moderateScale(16)}}>
          ...
          {!state.isLoading && (
            <>
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        <Text
                          ...
                          {appointmentSelectedDate && !!appointmentSelectedDateCount
              ...
              {!!productDetailData?.is_recurring_booking && (
                <View
                  style={[
                    {
        ...
        {suggestedCategoryProducts.length > 0 ? (
          <View style={{}}>
            <Text
              style={{
                ...styles.descriptiontitle,
        ...
        {!!productDetailData && !!productDetailData?.reviews ? (
          <View>
            <View
              style={{
                paddingVertical: moderateScale(14),
              ...
              <Text style={{color: isDarkMode ? colors.white : colors.black}}>
                {productDetailData?.reviews.length} global rating
              </Text>
            </View>
            <FlatList
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (isAppointmentPicker) {
                  ...
                  setAppointmentSelectedDateCount(false);
                } else {
                  setIsDatePicker(false);
                  setSelectedDate(null);
                  setAppointmentSelectedDateCount(false);
